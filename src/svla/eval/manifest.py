...
TRACKED_SOURCE_PATHS = (
    ...
    "src/svla/eval/protocol.py",
    "src/svla/evaluation_protocol.py",
    "src/svla/demo_recorder.py",
    "src/svla/eval/manifest.py",
    "src/svla/experiment_manifest.py",
    "src/svla/experiments/config.py",
    "src/svla/vision_observations.py",
    "src/svla/vision_dataset.py",
    ...
    "scripts/record_pickup_vision_demos.py",
...
def capture_environment() -> dict[str, str]:
    ...
    for name in (
        "PYTHONPATH",
        "SVLA_EXPERIMENT_CONFIG_PATH",
        "SVLA_EXPERIMENT_CONFIG_SHA256",
    ):
